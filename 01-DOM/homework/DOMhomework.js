...
spanTitle.innerText=spanTitle.innerText+' Mauricio Gongora Loria';
...
//let newarray=toDos.map(function(elem,i){ buildToDo(elem,i)}

// let newArrayy=[];
//for (let i=0; i<toDos.length; i++){
//     let newarray=buildToDo(toDos[i],i)
//     newArrayy.push(newToDo)}
